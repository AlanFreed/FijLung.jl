...
function figures2D(N::Int)
    ...
    plot(t1, F₁₁1, label="1: pleural", linecolor=:black, linewidth=3)
    plot!(t2, F₁₁2, label="2: interior", linecolor=:blue, linewidth=3)
    plot!(t3, F₁₁3, label="3: bronchiole", linecolor=:red, linewidth=3)
    ...
    plot(t1, detF1, label="1: pleural", linecolor=:black, linewidth=3)
    plot!(t2, detF2, label="2: interior", linecolor=:blue, linewidth=3)
    plot!(t3, detF3, label="3: bronchiole", linecolor=:red, linewidth=3)
    plot!(size=(809, 500)) # (500ϕ, 500), ϕ is golden ratio
    plot!(legend=:topright)
    plot!(left_margin=3mm, right_margin=3mm, top_margin=3mm, bottom_margin=3mm)
    ...
    plot(t1, trF1, label="1: pleural", linecolor=:black, linewidth=3)
    plot!(t2, trF2, label="2: interior", linecolor=:blue, linewidth=3)
    plot!(t3, trF3, label="3: bronchiole", linecolor=:red, linewidth=3)
    plot!(size=(809, 500)) # (500ϕ, 500), ϕ is golden ratio
    plot!(legend=:topright)
    plot!(left_margin=3mm, right_margin=3mm, top_margin=3mm, bottom_margin=3mm)
    ...
    figName = string("2DF11splined.png")
    figPath = string(my_dir_path, figName)
    savefig(figPath)
    ...
    plot(t1, dF₁₁1, label="1: pleural", linecolor=:black, linewidth=3)
    plot!(t2, dF₁₁2, label="2: interior", linecolor=:blue, linewidth=3)
    plot!(t3, dF₁₁3, label="3: bronchiole", linecolor=:red, linewidth=3)
    plot!(size=(809, 500)) # (500ϕ, 500), ϕ is golden ratio
    plot!(legend=:topright)
    plot!(left_margin=3mm, right_margin=3mm, top_margin=3mm, bottom_margin=3mm)
    xlabel!("time (s)")
    ...
    figName = string("2DdF11splined.png")
    figPath = string(my_dir_path, figName)
    savefig(figPath)
    ...
    plot(t1, d²F₁₁1, label="1: pleural", linecolor=:black, linewidth=3)
    plot!(t2, d²F₁₁2, label="2: interior", linecolor=:blue, linewidth=3)
    plot!(t3, d²F₁₁3, label="3: bronchiole", linecolor=:red, linewidth=3)
    plot!(size=(809, 500)) # (500ϕ, 500), ϕ is golden ratio
    plot!(legend=:topright)
    plot!(left_margin=3mm, right_margin=3mm, top_margin=3mm, bottom_margin=3mm)
    xlabel!("time (s)")
    ...
    figName = string("2Dd2F11splined.png")
    figPath = string(my_dir_path, figName)
    savefig(figPath)
    ...
    figName = string("2DF12splined.png")
    figPath = string(my_dir_path, figName)
    savefig(figPath)
    ...
    figName = string("2DdF12splined.png")
    figPath = string(my_dir_path, figName)
    savefig(figPath)
    ...
    figName = string("2Dd2F12splined.png")
    figPath = string(my_dir_path, figName)
    savefig(figPath)
    ...
    figName = string("2DF21splined.png")
    figPath = string(my_dir_path, figName)
    savefig(figPath)
    ...
    figName = string("2DdF21splined.png")
    figPath = string(my_dir_path, figName)
    savefig(figPath)
    ...
    figName = string("2Dd2F21splined.png")
    figPath = string(my_dir_path, figName)
    savefig(figPath)
    ...
    figName = string("2DF22splined.png")
    figPath = string(my_dir_path, figName)
    savefig(figPath)
    ...
    figName = string("2DdF22splined.png")
    figPath = string(my_dir_path, figName)
    savefig(figPath)
    ...
    figName = string("2Dd2F22splined.png")
    figPath = string(my_dir_path, figName)
    savefig(figPath)
    ...
    figName = string("2DdetFsplined.png")
    figPath = string(my_dir_path, figName)
    savefig(figPath)
    ...
    figName = string("2DtrFsplined.png")
    figPath = string(my_dir_path, figName)
    savefig(figPath)
...
function figures3D(N::Int)
    ...
    figName = string("dF11splined.png")
    figPath = string(my_dir_path, figName)
    savefig(figPath)
    ...
    figName = string("d2F11splined.png")
    figPath = string(my_dir_path, figName)
    savefig(figPath)
    ...
    figName = string("dF12splined.png")
    figPath = string(my_dir_path, figName)
    savefig(figPath)
    ...
    figName = string("d2F12splined.png")
    figPath = string(my_dir_path, figName)
    savefig(figPath)
    ...
    figName = string("dF13splined.png")
    figPath = string(my_dir_path, figName)
    savefig(figPath)
    ...
    figName = string("d2F13splined.png")
    figPath = string(my_dir_path, figName)
    savefig(figPath)
    ...
    figName = string("dF21splined.png")
    figPath = string(my_dir_path, figName)
    savefig(figPath)
    ...
    figName = string("d2F21splined.png")
    figPath = string(my_dir_path, figName)
    savefig(figPath)
    ...
    figName = string("dF22splined.png")
    figPath = string(my_dir_path, figName)
    savefig(figPath)
    ...
    figName = string("d2F22splined.png")
    figPath = string(my_dir_path, figName)
    savefig(figPath)
    ...
    figName = string("dF23splined.png")
    figPath = string(my_dir_path, figName)
    savefig(figPath)
    ...
    figName = string("d2F23splined.png")
    figPath = string(my_dir_path, figName)
    savefig(figPath)
    ...
    figName = string("dF31splined.png")
    figPath = string(my_dir_path, figName)
    savefig(figPath)
    ...
    figName = string("d2F31splined.png")
    figPath = string(my_dir_path, figName)
    savefig(figPath)
    ...
    figName = string("dF32splined.png")
    figPath = string(my_dir_path, figName)
    savefig(figPath)
    ...
    figName = string("d2F32splined.png")
    figPath = string(my_dir_path, figName)
    savefig(figPath)
    ...
    figName = string("dF33splined.png")
    figPath = string(my_dir_path, figName)
    savefig(figPath)
    ...
    figName = string("d2F33splined.png")
    figPath = string(my_dir_path, figName)
    savefig(figPath)
    ...
    figName = string("detFsplined.png")
    figPath = string(my_dir_path, figName)
    savefig(figPath)
